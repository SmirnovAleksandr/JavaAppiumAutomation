...
private static final String
    ...
    SEARCH_RESULT_BY_SUBSTRING_TPL = "//*[@resource-id='org.wikipedia:id/page_list_item_container'][//*[@text='{TITLE}'] and //*[@text='{DESCRIPTION}']]",
...
/* TEMPLATE METHODS */
    ...
    public  void waitForElementByTitleAndDescription(String title, String description){
        ...
        this.waitForElementPresent(By.xpath(Search_result_xpath), "Cannot find search result with title and description");
    }
